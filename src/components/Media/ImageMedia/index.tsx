...
import { buildCloudflareImageURL } from '../cloudflare'
...
export const ImageMedia: React.FC<MediaProps> = (props) => {
  ...
  const imagePresentation = presentation?.image
  const ratio = imagePresentation?.aspectRatio
  const hasValidRatio =
    ratio &&
  ...
  const loader =
    typeof src === 'string'
      ? ({
        ...
        }: Parameters<NonNullable<React.ComponentProps<typeof NextImage>['loader']>>[0]) =>
