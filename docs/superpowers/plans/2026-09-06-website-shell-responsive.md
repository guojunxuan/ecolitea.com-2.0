...
- [x] **Step 1: Write a source-level shell test that locks the removal boundary**
...
- [x] **Step 3: Simplify the Root Layout and providers**
...
- [x] **Step 4: Keep the now-unmounted modules until their remaining consumers are removed**
...
- [x] **Step 5: Run the focused test and static reference scan**
...
- [x] **Step 6: Commit the runtime removal boundary**
...
- [x] **Step 1: Extend the shell test with a complete public-theme reference scan**
...
- [x] **Step 2: Run the test and confirm the exact references fail**

Run: `corepack pnpm exec vitest run tests/int/website-shell.int.spec.tsx`

Expected: FAIL listing current Header, Footer, Hero, RichText, page, and UI primitive references.

- [x] **Step 3: Remove Header/Footer/Hero theme behavior**
...
- [x] **Step 4: Delete page bridge components and imports**
...
- [x] **Step 5: Collapse frontend styling to one public theme**
...
- [x] **Step 1: Add failing token and breakpoint assertions**
...
- [x] **Step 3: Replace the template theme and container definitions**
...
- [x] **Step 4: Verify tests and Tailwind compilation**
...
- [x] **Step 1: Write failing tests for every configured relationship target**
...
- [x] **Step 2: Run the test and confirm the current pages/posts type fails**

Run: `corepack pnpm exec vitest run tests/int/cms-link.int.spec.tsx`

- [x] **Step 3: Implement one reusable resolver in the existing Link owner**
...
- [x] **Step 1: Write failing active-branch adapter tests**
...
- [x] **Step 1: Write failing desktop interaction tests**
...
- [x] **Step 3: Implement DesktopNav state and semantics**
...
- [x] **Step 4: Implement the editorial Mega Menu**
...
- [x] **Step 5: Implement measured overflow**
...
- [x] **Step 4: Implement the pure reducer and MobileNav**
...
- [x] **Step 5: Implement lifecycle safety**
...
- [x] **Step 3: Implement server integration**
...
- [x] **Step 4: Implement fixed Header presentation**
...
- [x] **Step 3: Implement pure Footer adaptation**
...
- [x] **Step 1: Write failing Footer component tests**
...
- [x] **Step 3: Implement the server Footer**
...
- [x] **Step 4: Implement the non-desktop accordion**
...
- [x] **Step 3: Migrate only shell-facing wrappers**
...
- [x] **Step 4: Run focused and full integration tests**
...
- [x] **Step 2: Run the E2E test and diagnose any fixture prerequisite**
...
- [x] **Step 3: Run responsive visual review**
...
- [x] **Step 1: Verify forbidden theme references**
...
- [x] **Step 2: Verify dependencies and Payload schema stability**
...
- [x] **Step 4: Inspect the final diff and worktree ownership**
...
- [x] **Step 6: Complete using the branch-finishing workflow**
