...
describe('Footer Payload relationship depth', () => {
  it('renders a populated social platform icon from the depth-two site-settings shape', async () => {
      ...
      socialLinks: [
        {
          ...
          platform: {
            ...
            icon: {
              ...
              url: 'https://media.ecolitea.com/linkedin.svg',
              width: 24,
              height: 24,
            },
            createdAt: '2026-09-01T00:00:00.000Z',
    ...
    expect(icon?.getAttribute('src')).toContain('https://media.ecolitea.com/linkedin.svg')
    expect(icon?.getAttribute('width')).toBe('24')
    expect(icon?.getAttribute('height')).toBe('24')
    expect(document.querySelector('[data-footer-content="newsletter"]')).toBeNull()
  })
})
